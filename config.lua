...
local searchCategories = {"aircraft", "car", "tank", "train", "vehicle", "locomotive", "electric-hovercraft-equipment", "cargo-wagon", "armoured-cargo-wagon", "armoured-locomotive", "armoured-train", "armoured-vehicle"}
